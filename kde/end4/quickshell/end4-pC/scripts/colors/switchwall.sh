...
SHELL_CONFIG_FILE="$XDG_CONFIG_HOME/illogical-impulse/end4-pC/config.json"
MATUGEN_DIR="$XDG_CONFIG_HOME/matugen"
ILLOGICAL_IMPULSE_VIRTUAL_ENV="${ILLOGICAL_IMPULSE_VIRTUAL_ENV:-$HOME/.local/share/end4/kde-material-you-colors-venv}"
